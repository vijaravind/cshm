function [F1, M1, F2, M2, F3, M3] = backward3(mass1, Ij1, X1dot, X1ddot, ...
                                        mass2, Ij2, X2dot, X2ddot, ...
                                        mass3, Ij3, X3dot, X3ddot, ...
                                        Fe, Me, Le)
    % [F1, M1, F2, M2, F3, M3] = backward3(mass1, Ij1, X1dot, X1ddot, ...
    %                               mass2, Ij2, X2dot, X2ddot, ...
    %                               mass3, Ij3, X3dot, X3ddot, ...
    %                               Fe, Me, Le)
    %
    ...
    % Ij1, Ij2, Ij3 - Inertia matrices of each segment
    ...
    %
    [F3, M3] = newtontimeloop(mass3, Ij3, X3dot, X3ddot, Fe, Me, Le);
    [F2, M2] = newtontimeloop(mass2, Ij2, X2dot, X2ddot, F3, M3, L3);
    [F1, M1] = newtontimeloop(mass1, Ij1, X1dot, X1ddot, F2, M2, L2);
end
