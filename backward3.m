function [F1, M1, F2, M2, F3, M3] = backward3(mass1, Ig1, X1dot, X1ddot, ...
                                        mass2, Ig2, X2dot, X2ddot, ...
                                        mass3, Ig3, X3dot, X3ddot, ...
                                        Fe, Me, Le)
    % [F1, M1, F2, M2, F3, M3] = backward3(mass1, Ig1, X1dot, X1ddot, ...
    %                               mass2, Ig2, X2dot, X2ddot, ...
    %                               mass3, Ig3, X3dot, X3ddot, ...
    %                               Fe, Me, Le)
    %
